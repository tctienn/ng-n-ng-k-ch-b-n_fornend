<template  >
  <v-navigation-drawer :width="250" class="bg-blue">
    ...
    <v-list v-model:opened="open">
      ...
      <v-list-group v-for="(e, i) in data" :key="i" :value="e.tyle">
        ...
        <v-list-item
          ...
          v-on:click="$emit('ay', item.navigation)"
          :key="index"
          :title="item.name"
